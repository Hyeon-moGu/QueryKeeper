...
public class LoggingPreparedStatement extends AbstractDelegatingPreparedStatement implements PreparedStatement {
    ...
    @Override public void setObject(int parameterIndex, Object x) throws SQLException { capture(parameterIndex, x); delegate.setObject(parameterIndex, x); }
    @Override public void setString(int parameterIndex, String x) throws SQLException { capture(parameterIndex, x); delegate.setString(parameterIndex, x); }
    @Override public void setInt(int parameterIndex, int x) throws SQLException { capture(parameterIndex, x); delegate.setInt(parameterIndex, x); }
    @Override public void setLong(int parameterIndex, long x) throws SQLException { capture(parameterIndex, x); delegate.setLong(parameterIndex, x); }
    @Override public void setDouble(int parameterIndex, double x) throws SQLException { capture(parameterIndex, x); delegate.setDouble(parameterIndex, x); }
    ...
    @Override public void setObject(int parameterIndex, Object x, SQLType targetSqlType, int scaleOrLength) throws SQLException { delegate.setObject(parameterIndex, x, targetSqlType, scaleOrLength); }
    @Override public void setObject(int parameterIndex, Object x, SQLType targetSqlType) throws SQLException { delegate.setObject(parameterIndex, x, targetSqlType); }
    @Override public long executeLargeUpdate() throws SQLException { return delegate.executeLargeUpdate(); }
